...
::call  "%JAVA_HOME%\bin\%JAVA_COMMAND%" -cp %classPath%;%LIBS%;"%CURRENT_DIR%binaries.jar"; org.rg.game.lottery.application.SubscriptionExpirationDateUpdater Fusi-Francesco,6w;
...
::call  "%JAVA_HOME%\bin\%JAVA_COMMAND%" -cp %classPath%;%LIBS%;"%CURRENT_DIR%binaries.jar"; org.rg.game.lottery.application.SubscriptionExpirationDateUpdater Berni-Riccardo,6w;
